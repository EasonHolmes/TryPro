package com.cui.trypro.View.circlerefreshlayout;
...
import com.cui.trypro.View.circlerefreshlayout.AnimationView;
...
//                Log.i(TAG, "should invoke");
    ...
    public void setOnLoadMoreListener(OnCircleRefreshListener onCircleRefreshListener) {
        this.onCircleRefreshListener = onCircleRefreshListener;
    }
