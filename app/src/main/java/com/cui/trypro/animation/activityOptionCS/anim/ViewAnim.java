package com.cui.trypro.animation.activityOptionCS.anim;
...
import com.cui.trypro.animation.activityOptionCS.util.Position;
...
public class ViewAnim {
	...
	private TransitionCompat.ViewAnimationListener mListener;
	...
	public void startViewTweensAnim(final View fromView,final View toView,int startOffsetY,int finalOffsetY) {
		...
		xAnim.addUpdateListener(new AnimUpdateListener(fromView, startBounds, finalBounds));
	...
	public void addListener(TransitionCompat.ViewAnimationListener listener) {
		mListener = listener;
	}
